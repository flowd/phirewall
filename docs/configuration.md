...
The `Firewall` class provides methods for managing throttle counters and bans at runtime.
...
> **Note:** This resets fixed-window throttle counters only. Sliding window throttle entries expire naturally and cannot be reset individually.
