 ...
 * per rule. Distinct rules always produce distinct ban keys (the rule name is part of the
 * key), and this evaluator returns on the FIRST decision, so no later rule's ban-key read can
 * observe a ban written by an earlier rule in the same request — batching upfront is therefore
